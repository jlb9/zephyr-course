...
{
    return DEVICE_DT_GET(DT_ALIAS(led_sensor));
}

/* --- fetch: turns the LED on --- */
...
/* --- read: turns the LED off and prints the result --- */
...
/* --- info: prints device name and status --- */
...
/* --- subcommand registration and root command --- */
